            ...
            <div className="rounded-lg shadow-md p-8 w-full max-w-md bg-gradient-to-t from-[#f09798] via-[#BEAF5E] to-[#b5c96b]">
                <div className=" rounded-md flex flex-col justify-center m-4">
                    <div className='relative inline-block m-4'>
                        <Image src="/raccoon.webp" alt="Bird" width={400} height={300} className="rounded-lg" />
                    </div>

                    <div>
                        <p className="text-3xl m-4">Raccoon</p>
                        <p className="text-xl m-4 italic">Procyon lotor</p>

                    </div>
                    <div className='flex flex-wrap mb-3 ml-1 '>
                        <p className="bg-primary-dark-gray rounded-lg text-xs m-2 p-2 text-white">Head Injured</p>
                        <p className="bg-primary-dark-gray rounded-lg text-xs m-2 p-2 text-white">Alive</p>
                        <p className="bg-primary-dark-gray rounded-lg text-xs m-2 p-2 text-white">Male</p>
