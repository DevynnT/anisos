          ...
          <div className="bg-white rounded-md shadow-lg">
            <div className="place-self-center">
              <p className="text-2xl font-semibold m-4">
                This Animal&apos;s Condition
              </p>
            </div>
            <div className="flex flex-wrap mb-3 ml-1 ">
              <span className="bg-gray-200 rounded-lg text-xs font-semibold m-2 p-2">
                Leg Injured
              </span>
              <span className="bg-gray-200 rounded-lg text-xs font-semibold m-2 p-2">
                Alive
            ...
            <div className="flex flex-col flex-wrap mb-3 ml-1  m-4 p-4 ">
              ...
              <br></br>
              <p>
                1. Safety First: Approach the eagle carefully. Use protection
                like gloves.
              </p>
              <br></br>
              <p>
                2. Call Authorities: Report injured eagles to local wildlife
                professionals for guidance and rescue.
              </p>
              <br></br>
              <p>
                3. Maintain Distance: Minimize eagles stress by keeping
                distance. If in a risky place, cover it&apos;s head gently with a
                towel.
              </p>
              <br></br>
              <p>
                4. Observe: Watch the eagle from afar, noting details about its
                condition and surroundings for the arriving experts.
              </p>
            </div>
          </div>
